...
from apps.mascota.views import index, mascota_view, mascota_list, mascota_edit, listado, mascota_delete, MascotaList, MascotaCreate, MascotaUpdate, MascotaDelete
